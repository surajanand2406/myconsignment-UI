                                        ...
                                        if(data.isRead===false)
                                        {
                                            return(
                                                ...
                                                <div style={{display:'flex',alignItems:'center',padding:'5px',borderBottom:"solid 1px #c9c7c7"}} onClick={()=>{this.handleOpenChat(data._id)}} >
                                                    <Avatar size={55} src={data.sellerProfilePic} />
                                                    <div style={{padding:'5px'}}>
                                                      
                                                        <h3 style={{margin:0,color:'#8b0000',display:'flex',alignItems:'center'}}>{data.sellerName}<p style={{fontSize:'1px',marginLeft:'5px',border:'solid 3px red',borderRadius:'50px'}}>.</p></h3>
                                        ...
                                        else
                                        {
                                            return(
                                                ...
                                                <div style={{display:'flex',alignItems:'center',padding:'5px',borderBottom:"solid 1px #c9c7c7"}} onClick={()=>{this.handleOpenChat(data._id)}} >
                                                    <Avatar size={55} src={data.sellerProfilePic} />
                                                    <div style={{padding:'5px'}}>
                                                        <h3 style={{margin:0,color:'#8b0000'}}>{data.sellerName}</h3>
                                                        <p style={{margin:0,color:'gray'}}>Hello, how are you?</p>
                                                    </div>
                                                </div>
                        ...
                        </div>
                        {
                            ...
                            <div className="messeges-body-chat">
                                <div className="chat-header">
                                    <div style={{display:'flex',alignItems:'center'}}>
                                        <Avatar size={40} style={{marginLeft:'10px'}} />
                                        <h2 style={{margin:0,color:'white',marginLeft:'10px'}}>{this.state.readMesseges[0].sellerName}</h2>
                                    </div>
                                    <div className="list-icon">
                                        <Icon type="menu" style={{fontSize:'20px',color:'white'}} onClick={()=>this.setState({visible:true})} />
                                    </div>
                                                            ...
                                                            return(
                                                                ...
                                                                <div style={{display:'flex',width:'100%',alignItems:'flex-start',marginBottom:'10px'}}>
                                                                    ...
                                                                    <div style={{width:'10%',display:'flex',justifyContent:'center'}}>
                                                                        <Avatar size={this.state.windowWidth < 678 ? 45 : 55} />
                                                                    </div>
                                                                </div> 
                                                        ...
                                                        else if(msg.Proposal.Price !=='' && msg.Proposal.Shipping !== '' && msg.Proposal.proposalDetail !== '')
                                                        {
                                                            return(
                                                                ...
                                                                <div style={{display:'flex',alignItems:'flex-start',marginBottom:'10px'}}>
                                                                    <div style={{width:'90%',marginRight:'5px',display:'flex',justifyContent:'flex-end'}}>
                                                                        <p style={{padding:'10px',margin:0,backgroundColor:'#eeeeee',borderRadius:'5px',display:'flex',alignItems:'center'}}>Propsal <h4 className="View" style={{margin:0,marginLeft:'10px'}} onClick={()=>this.openViewProposalModal(i)}>View <Icon type="caret-down" /></h4></p>
                                                                    </div>
                                                                    <div style={{width:'10%',display:'flex',justifyContent:'center'}}>
                                                                        <Avatar size={this.state.windowWidth < 678 ? 45 : 55} />
                                                                    </div>
                                                            ...
                                                            return(
                                                                        <div style={{display:'flex',alignItems:'flex-start',marginBottom:'10px'}}>
                                                                                ...
                                                                                <div style={{width:'90%',marginLeft:'0px',display:"flex",justifyContent:"flex-start"}}>
                                                                                    <p style={{padding:'10px',margin:0,color:'white',backgroundColor:'#8b0000',borderRadius:'5px'}}>{msg.Text}</p>
                                                                                </div>
                                                                        </div>
                                                                ...
                                                                return(
                                                                        ...
                                                                        <div style={{display:'flex',alignItems:'flex-start',marginBottom:'10px'}}>
                                                                                ...
                                                                                <div style={{width:'90%',display:"flex"}}>
                                                                                    <p style={{padding:'10px',margin:0,color:'white',backgroundColor:'#8b0000',borderRadius:'5px',display:'flex',alignItems:'center'}}>Propsal <h4 className="View" style={{margin:0,marginLeft:'10px',color:'white'}} onClick={()=>this.openViewProposalModal(i)}>View <Icon type="caret-down" /></h4></p>
                                                                                </div>   
                                                                        </div>
                                                                )
                                                            }
                                    ...
                                    <Modal visible={this.state.isViewProposal} onCancel={this.closeViewProposalModal} title="Propsal" footer={null}>
                                        <div> 
                                            ...
                                            <div>
                                                ...
                                                <input type="date" onChange={(val)=>{this.setState({endDate:val.target.value})}} style={{width:'100%',marginBottom:'20px'}} />
                                                <Button style={{backgroundColor:'#B17E4E',color:'white'}} onClick={this.handleAcceptProposal}>Accept Proposal</Button>   
                                            </div>
                                        </div>
                                    </Modal>
                                ...
                                <div className="chat-footer">
                                    ...
                                    <div className="chat-footer-btns">
                                        <div style={{display:'flex',alignItems:'center'}}>
                                            ...
                                            <Button style={{color:'white',marginLeft:'5px',backgroundColor:'#B17E4E'}} size="default" onClick={this.openMakeProposalModal}>Make Propsal</Button>
                                        </div>
